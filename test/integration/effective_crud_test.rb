...
class EffectiveCrudTest < ActionDispatch::IntegrationTest
  test 'controller' do
    ...
    assert_equal '/thangs', @controller.resource_index_path
    assert_equal '/thangs/new', @controller.resource_new_path
  ...
  test 'index' do
    ...
    assert_equal 'EffectiveThangsDatatable', @controller.view_context.assigns['datatable'].class.name
  end
  ...
  test 'create valid' do
    post thangs_url, params: { effective_thang: { title: 'Title', body: 'Body'} }
    assert_redirected_to thang_path(Effective::Thang.last)
  ...
  test 'create invalid' do
    post thangs_url, params: { effective_thang: { title: 'Title', body: nil} }
    assert_response :success
  ...
  test 'update valid' do
    ...
    patch thang_url(thang), params: { effective_thang: { id: thang.id, title: 'Title2', body: 'Body2'} }
    assert_equal 'Successfully updated Title2', flash[:success]
    assert_redirected_to edit_thang_path(thang)
  ...
  test 'update invalid' do
    ...
    patch thang_url(thang), params: { effective_thang: { id: thang.id, title: 'Title2', body: nil} }
    assert_response :success
