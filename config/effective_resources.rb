EffectiveResources.setup do |config|
  ...
  #
  # These are the default btn class on links generated by render_resource_buttons method
  # config.default_new_action_button_class = 'btn btn-success'
  # config.default_action_button_class = 'btn btn-primary'
  # config.default_delete_action_button_class = 'btn btn-danger'
  # config.default_button_class = 'btn btn-secondary'
